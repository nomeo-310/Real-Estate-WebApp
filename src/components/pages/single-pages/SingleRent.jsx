...
const SingleRent = () => {
  const {id} = useParams()
  const singleHouseData = rentApartmentData.find((data) => data.id === +id)
      ...
      <div className="container">
        <div className="single-rent-top margin-b-40">
          ...
          <div className="single-rent-top-right">
            ...
            <h3 className="normal-text normal-sm">Annual rent: <span className="mdi mdi-currency-ngn"></span>{singleHouseData.annual_rent.toLocaleString()}</h3>
            <h3 className="normal-text normal-sm text-capital"><span className="mdi mdi-shield-check-outline base-color"></span> {singleHouseData.property_type} property</h3>
        ...
        <div className="apartment-desc-et-input">
          <div className="apartment-desc margin-b-10">
            ...
            <div className="m-payment margin-b-10">
              ...
              <h3 className="normal-text normal-sm">Security fee: 
          ...
          <div className="apartment-input-form">
            <div className="apartment-input-form-content">
              <div className="apartment-input-price margin-b-20">
                <div>
                  <h3 className="normal-text normal-sm complement-color">Monthly rent:</h3>
                  <h2 className="head-text head-xsm complement-color"><span className="mdi mdi-currency-ngn"></span>{singleHouseData.monthly_rent.toLocaleString()}</h2>
                </div>
              </div>
