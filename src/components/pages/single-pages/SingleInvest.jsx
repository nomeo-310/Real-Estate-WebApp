...
const SingleInvest = () => {
  const {id} = useParams()
  const singleHouseData = investApartmentData.find((data) => data.id === +id)
    ...
    <div className='single-rent padding-y'>
        ...
        <div className="single-rent-top margin-b-40">
          ...
          <div className="single-rent-top-right">
            ...
            <h3 className="normal-text normal-sm text-capital">total annual returns: {singleHouseData.total_returns}%</h3>
            <h3 className="normal-text normal-sm text-capital">total available shares: {singleHouseData.available_shares.toLocaleString()}</h3>
            <h3 className="normal-text normal-sm text-capital">total remaining shares: {singleHouseData.remaining_shares.toLocaleString()}</h3>
            <h3 className="normal-text normal-sm text-capital">hold period: {singleHouseData.hold_time} <span className="text-lower">years</span></h3>
            <ul>
          ...
          <div className="apartment-input-form">
            <div className="apartment-input-form-content">
              <div className="apartment-input-price margin-b-20">
                <div>
                  <h3 className="normal-text normal-sm complement-color">Starting price: </h3>
                  <h2 className="head-text head-xsm complement-color"><span className="mdi mdi-currency-ngn"></span>{singleHouseData.share_price.toLocaleString()} <span className="normal-text normal-tiny">per shares</span></h2>
                </div>
